...
# The initialization vector (IV) is also unknown. However, given {C, IV} used in a CBC-decrypting padding oracle and validates the plaintext P's padding is vulnerable.
